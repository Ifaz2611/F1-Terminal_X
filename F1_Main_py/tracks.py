...
class Track:
    ...
    city: str
    name: str
    fastf1_name: str  # identifier for fastf1.get_session(year, fastf1_name, session)
...
TRACKS: Dict[int, Track] = {
    ...
    14: Track(14, "Spain",         "Madrid",          "Madring",                         "Spain"),  # FastF1 uses 'Spain' for Barcelona; fallback handled via EventName
...
# Legacy dict format for backward-compat with scripts that expect dicts
